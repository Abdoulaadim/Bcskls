<x-app-layout>
    ...
    <section class="max-w-4xl p-6 mx-auto bg-gray-800 rounded-md shadow-md dark:bg-gray-800 mt-8">
        <h1 class="text-xl font-bold text-white capitalize dark:text-white text-center mb-14"> <u>Ajouter Courier Entrant </u></h1>
        <form method="post" action="{{route('ajoutercentrant')}}">
            @csrf
