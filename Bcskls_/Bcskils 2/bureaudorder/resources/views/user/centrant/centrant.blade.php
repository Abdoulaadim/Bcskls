<x-app-layout>
    ...
    <div class="text-center text-3xl ">Courrier Entrant</div>
        <div class="col-sm-12">
                        ...
                        <tbody class=" divide-gray-200">
                            ...
                            <td class="px-6 py-4 ">
                                ...
                                @if( Auth::user()->role == "Admin" )
                                    <form method="POST" action="{{ route('centrant.delete', $data->id) }}">
                                        @csrf
