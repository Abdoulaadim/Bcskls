<x-app-layout>
    ...
    <section class="container px-6 py-4 mx-auto mt-24">
        <div class="text-center text-3xl ">Fax</div>
        <div class="col-sm-12">
                        ...
                        <table class=' w-full whitespace-nowrap rounded-lg bg-white divide-y divide-gray-300 overflow-hidden'>
                            <thead class="bg-gray-900">
                                <tr class="text-white text-left">
                                    <th class="font-semibold text-sm uppercase px-6 py-4"> N° fax </th>
                                    <th class="font-semibold text-sm uppercase px-6 py-4"> Tele Fax </th>
                                    <th class="font-semibold text-sm uppercase px-6 py-4"> telephone </th>
                                    <th class="font-semibold text-sm uppercase px-6 py-4"> Emetteur </th>
                                    <th class="font-semibold text-sm uppercase px-6 py-4"> recepteur </th>
                                    <th class="font-semibold text-sm uppercase px-6 py-4"> Date </th>
                                    <th class="font-semibold text-sm uppercase px-6 py-4"> objet </th>
                                    <th class="font-semibold text-sm uppercase px-6 py-4"> descritpion </th>
                            ...
                            <tbody class=" divide-gray-200">
                                ...
                                <tr>
                                    ...
                                    @if( Auth::user()->role == "Admin" )
                                        <form method="POST" action="{{ route('fax.delete', $data->id) }}">
                                            @csrf
