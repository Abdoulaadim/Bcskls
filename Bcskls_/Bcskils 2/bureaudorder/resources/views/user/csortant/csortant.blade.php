<x-app-layout>
    ...
    <div class="text-center text-3xl ">Courrier Sortant</div>
        <div class="col-sm-12">
                ...
                <div>
                    ...
                    <table class=' w-full whitespace-nowrap rounded-lg bg-white divide-y divide-gray-300 overflow-hidden'>
                        <thead class="bg-gray-900">
                            ...
                            <th class="font-semibold text-sm uppercase px-6 py-4"> Date saisie  </th>
                                <th class="font-semibold text-sm uppercase px-6 py-4"> Reference  </th>
                                <th class="font-semibold text-sm uppercase px-6 py-4"> Objet  </th>
                                <th class="font-semibold text-sm uppercase px-6 py-4"> Type  </th>
                                <th class="font-semibold text-sm uppercase px-6 py-4"> Date depart  </th>
                                <th class="font-semibold text-sm uppercase px-6 py-4"> expiditeur  </th>
                                <th class="font-semibold text-sm uppercase px-6 py-4"> destinataire  </th>
                                <th class="font-semibold text-sm uppercase px-6 py-4"> Division  </th>
                                <th class="font-semibold text-sm uppercase px-6 py-4"> Service  </th>
                                <th class="font-semibold text-sm uppercase px-6 py-4"> Employee  </th>
                                <th class="font-semibold text-sm uppercase px-6 py-4"> Etat  </th>
                        ...
                        <tbody class=" divide-gray-200">
                            ...
                            <td class="px-6 py-4 ">
                                ...
                                @if( Auth::user()->role == "Admin" )
                                    <form method="POST" action="{{ route('csortant.delete', $data->id) }}">
                                        @csrf
